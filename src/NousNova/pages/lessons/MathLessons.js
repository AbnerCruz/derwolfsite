...
const mathTeachers = teachersArray.filter((teacher) => teacher.disciplines.includes("Matemática"));
  ...
  return (
    <div className="HomePageGlobalDiv">
      <div className="NousNovaLessons">
        {/* Título */}
        <section id="title">
          <h1>Aulas Particulares de Matemática</h1>
          <h3>Orientação personalizada para mentes em expansão</h3>
        </section>
